...
function editing() {
    ...
    if (currentPlaylist == null) {
        ...
        currentPlaylist.songs.forEach(e => {
            ...
            block.innerHTML += "<div class = 'track'> <div class='track__art'> <img src= " + e.art + "></div><div class='track__title'>" + e.name + "</div><div class='track__explicit'><span class='label'>" + (e.explicit ? 'Explicit': 'Not Explicit') + "</span> </div></div>";
        }
